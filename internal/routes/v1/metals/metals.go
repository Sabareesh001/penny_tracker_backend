...
import (
	add_metal_tracking "github.com/Sabareesh001/penny_tracker_backend/internal/routes/v1/metals/addMetalTracking"
...
func MetalRoutes(router *gin.RouterGroup, DB *gorm.DB) {
		...
		add_metal_tracking.AddMetalTracking(metalRoutes,DB)
}